...
class HotelRoomCell: UICollectionViewCell {
    let carouselView = ImageCarouselView()
    ...
    override init(frame: CGRect) {
        ...
        [priceLabel, priceForItLabel].forEach { priceHStack.addArrangedSubview($0) }
        [carouselView, hotelName, tagListView, priceHStack, blueNextButton].forEach { addSubview($0) }
    ...
    func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            tagListView.topAnchor.constraint(equalTo: hotelName.bottomAnchor, constant: 8),
            ...
            priceHStack.topAnchor.constraint(equalTo: tagListView.bottomAnchor, constant: 16),
            priceHStack.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 16),
